            ...
            <div class="card br-50">
                ...
                <div class="">
                    ...
                    <div class="cardd-header d-flex justify-content-between bordered-bottom padding-x-lg padding-right-lg pt-1">
                        <h4 class="header-md pt-2 position-relative mb-0 mt-9px">Category</h4>
                    ...
                    <div class="card-body pt-2 mb-5 px-0">
                            ...
                            <table class="dataTable display table table-hover first-td-border-0 padding-right-lg th-sm table-striped whitespace-nowrap w-100" id="categoryDataTable" width="100%">
                                <thead>
                                    <tr>
                                        <th>Caster</th>
                                        <th>Category</th>
