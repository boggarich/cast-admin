<script lang="ts">
    ...
    export default {
        ...
        mounted() {
            ...
            $('#paymentGatewayDataTable').dataTable({
                searching: false,
                lengthChange: false,
                info: false,
                stateSave: true,
                ...
                <div class="">
                    ...
                    <div class="content-wrapper d-flex pt-35 pb-35 align-items-center">
                        ...
                        <div class="input-wrapper has-icon w-100 d-flex">
                            ...
                            <input type="email" class="form-control flex-grow-1 main-search" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category Name">
                    ...
                    <div class="content-wrapper d-flex pb-35 align-items-center pr-3">
                        ...
                        <div class="d-flex justify-content-between w-100">
                            <button class="btn btn-custom-violet dropdown-toggle dropdown-lg ml-auto" type="button" data-toggle="dropdown" aria-expanded="false">
                                Add Provider
                    ...
                    <div class="cardd-header d-flex justify-content-between bordered-bottom padding-x-lg padding-right-lg pt-1">
                        <h4 class="header-md pt-2 position-relative mb-0 mt-9px">Payment Gateway List</h4>
                    ...
                    <div class="card-body pt-2 mb-5 px-0">
                            ...
                            <table class="dataTable display table table-hover first-td-border-0 padding-right-lg th-sm table-striped whitespace-nowrap w-100" id="paymentGatewayDataTable" width="100%">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>PayStack Checkout</td>
                                        <td>sdn8r3i8ifda8dwsd9</td>
                                        <td>https://api.paystack.co/transaction/</td>
                                        <td>Yes</td>
                                        <td>Redirect to Checkout</td>
                                        <td>
                                            <div class="dropdown">
