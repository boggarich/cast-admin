                ...
                <div class="">
                    ...
                    <div class="content-wrapper wrap d-flex pb-35 align-items-center pr-3 ">
                        ...
                        <div class="d-flex justify-content-between w-100">
                            ...
                            <button class="btn btn-custom-violet dropdown-toggle dropdown-lg" type="button" data-toggle="dropdown" aria-expanded="false">
                                Add  a caster
                                <svg width="10" height="5" viewBox="0 0 10 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 0L5 5L10 0H0Z" fill="#323232"/>
                                </svg>
                    ...
                    <div class="cardd-header d-flex justify-content-between bordered-bottom padding-x-lg padding-right-lg pt-30">
                        <h4 class="header-md pt-2 position-relative mb-0 mt-9px">Casters</h4>
                    ...
                    <div class="card-body pt-2 mb-5 px-0">
                            ...
                            <table class="dataTable display table table-hover first-td-border-0 padding-right-lg th-sm table-striped" id="castersDataTable" width="100%">
                                <thead>
                                    <tr>
                                        <th>Date</th>
                                        <th>Username</th>
