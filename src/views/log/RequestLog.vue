        ...
        <section class="section-1">
            ...
            <div class="card br-50">
                ...
                <div class="">
                    ...
                    <div class="content-wrapper d-flex pt-35 pb-35 align-items-center">
                        <h4 class="header-md mb-0 mr-4 pl-12">Search</h4>

                        <div class="input-wrapper has-icon w-100 d-flex">

                            <input type="email" class="form-control flex-grow-1 main-search" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Search">

                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_281_4674)">
                                <path d="M15.5 14H14.71L14.43 13.73C15.41 12.59 16 11.11 16 9.5C16 5.91 13.09 3 9.5 3C5.91 3 3 5.91 3 9.5C3 13.09 5.91 16 9.5 16C11.11 16 12.59 15.41 13.73 14.43L14 14.71V15.5L19 20.49L20.49 19L15.5 14ZM9.5 14C7.01 14 5 11.99 5 9.5C5 7.01 7.01 5 9.5 5C11.99 5 14 7.01 14 9.5C14 11.99 11.99 14 9.5 14Z" fill="#341454"/>
                                </g>
                                <defs>
                                <clipPath id="clip0_281_4674">
                    ...
                    <div class="content-wrapper d-flex pb-35 align-items-center pr-3">
                        <h4 class="header-md mb-0 mr-4 opacity-0">Search</h4>
                        <div class="d-flex justify-content-between w-100">
                            <button class="btn btn-custom-violet dropdown-toggle dropdown-lg px-lg ml-auto" type="button" data-toggle="dropdown" aria-expanded="false">
                                Add Request
                    ...
                    <div class="cardd-header d-flex justify-content-between bordered-bottom padding-x-lg padding-right-lg pt-1">
                        <h4 class="header-md pt-2 position-relative mb-0 mt-9px">API Requests List</h4>
                    ...
                    <div class="card-body pt-2 mb-5 px-0 overflow-hidden pr-3 mr-4">
                        
                            <table class="dataTable display table table-hover first-td-border-0 padding-right-lg th-sm table-striped whitespace-nowrap w-100" id="requestLogDataTable" width="100%">
                                <thead>
                                    <tr>
                                        <th>Raw request</th>
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td title="kldjalkdlsajdslmndaldssd/s,,c.csc.s;[alsakd;sddmasdsdsakljsljdkjsldaksdlskdlsdksdnjjlsnacnisaclsncasncosnclascsacnlsicsk;sajdosa;kjdosdopksap">kldjalkdlsajdslmndaldssd/s,,c.csc.s;[alsakd;sddmasdsdsakljsljdkjsldaksdlskdlsdksdnjjlsnacnisaclsncasncosnclascsacnlsicsk;sajdosa;kjdosdopksap</td>
                                    </tr>
                                    <tr>
                                        <td title="kldjalkdlsajdslmndaldssd/s,,c.csc.s;[alsakd;sddmasdsdsakljsljdkjsldaksdlskdlsdksdnjjlsnacnisaclsncasncosnclascsacnlsicsk;sajdosa;kjdosdopksap">kldjalkdlsajdslmndaldssd/s,,c.csc.s;[alsakd;sddmasdsdsakljsljdkjsldaksdlskdlsdksdnjjlsnacnisaclsncasncosnclascsacnlsicsk;sajdosa;kjdosdopksap</td>
                                    </tr>
