                ...
                <div class="">
                    ...
                    <div class="content-wrapper d-flex pt-35 pb-35 align-items-center">
                        ...
                        <div class="input-wrapper has-icon w-100 d-flex">
                            ...
                            <input type="email" class="form-control flex-grow-1 main-search" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Error">
                    ...
                    <div class="cardd-header d-flex justify-content-between bordered-bottom padding-x-lg padding-right-lg pt-1">
                        <h4 class="header-md pt-2 position-relative mb-0 mt-9px">Error Log List</h4>
                    ...
                    <div class="card-body pt-2 mb-5 px-0 overflow-hidden pr-3 mr-4">
                            ...
                            <table class="dataTable display table table-hover first-td-border-0 padding-right-lg th-sm table-striped w-100" id="errorLogDataTable" width="100%">
                                <thead>
                                    <tr>
                                        <th>Error</th>
                                        <th>Error Message</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Sdhsjdhkasdhkjsha</td>
                                        <td><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed</p></td>
                                        <td><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nost</p></td>
                                    </tr>
...
<style lang="scss" scoped>
    ...
    #errorLogDataTable.dataTable tbody tr td p:hover {
        line-height: inherit;
    ...
    #errorLogDataTable.dataTable tbody tr td p {
        line-height: 1.6;
        -webkit-line-clamp: 2;
        max-height: 3.2rem;
        overflow: hidden;
